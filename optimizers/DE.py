...
def DE(population_size, individual_size,
        lower_bound, upper_bound, fitness_func,iters_count, mutation_factor=0.5, crossover_ratio=0.7, stopping_func=None, plt_func=None, verbose=False):
    ...
    while t < iters_count:
        ...
        if plt_func is not None:
            plt_func(t, population, result.leader_solution)
